...
<?php
$redirectUrl = "https://www.wbnarayanaschools.in/new-page/index.html";
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8">
                    ...
                    <!-- Thank You Card -->
                    <div class="thankyou-card text-center p-4 p-md-5">
                        
                        <img src="thankyou.gif" class="img-fluid mb-4 thankyou-img" alt="Thank You">

                       
                        <p class="thankyou-text" style="background-color:#007fc0;color:#fff;padding:20px;border-radius:10px;">
