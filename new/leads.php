...
// die();
    if (!isset($_SESSION['otp'][$phone]) || $_SESSION['otp'][$phone] != $user_otp) {
        echo "<script>alert('OTP verification failed'); window.location='https://www.wbnarayanaschools.in/new/';</script>";
        exit;
    }
  ...
  if (isset($phone) && $phone!='') {
    ...
    //     $conn->close();
        ...
        if(isset($from_for) && $from_for=='feesstructure'){
          ...
          echo "<script language='javascript' type='text/javascript'> 
          window.location = 'https://www.wbnarayanaschools.in/new/thankyou.php';</script>";
            }
        }
        ...
        echo "<script language='javascript' type='text/javascript'> 
          ...
          window.location = 'https://www.wbnarayanaschools.in/new/';</script>";  
      }
