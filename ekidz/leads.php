...
//   $resultJson = json_decode($result);
  ...
  if (isset($phone) && $phone!='') {
    ...
    $branch_force = (isset($_POST['branch_force']) && $_POST['branch_force']!='') ? $_POST['branch_force'] : '';
    ...
    //     $conn->close();
        ...
        if(isset($_POST['downloadBrochure']) && $_POST['downloadBrochure']=='YES'){
            header("Location: thankyou.php?branch=".$branch_force."&download=YES");
                exit;
        }else if(isset($_POST['feesstructure']) && $_POST['feesstructure']=='YES'){
            header("Location: thankyou.php?branch=".$branch_force."&feesstructure=YES");
        }else{
            
          echo "<script language='javascript' type='text/javascript'> 
          window.location = 'https://www.wbnarayanaschools.in/ekidz/thankyou.php';</script>";
            
        }
      }else{
        echo "<script language='javascript' type='text/javascript'> 
          alert('Name is required.');
          window.location = 'https://www.wbnarayanaschools.in/ekidz/';</script>";  
      }
