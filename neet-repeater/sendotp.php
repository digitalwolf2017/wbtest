...
$page_section = (isset($input['page_section']) && $input['page_section']!='') ? $input['page_section'] : '';
...
(entrydate,name,parent_email,phone,city,branch,board,reservation_type,course,utm_source,utm_medium,utm_campaign,redirect_from,page_section)
VALUES(NOW(),?,?,?,?,?,?,?,?,?,?,?,?,?)";
