...
function getClassCategory(classValue) {
    if (!classValue) {
        return '';
    }

    // Category 1: Till Class 2
    const category1 = [
        'E-KIDZ-N (Nursery)',
        'E-KIDZ-PP1 (L.K.G)',
        'E-KIDZ-PP2 (U.K.G)',
    ...
    // Category 2: Class 3 to Class 10
    const category2 = [
        'E-CHAMPS-3',
        'E-CHAMPS-4',
        'E-CHAMPS-5',
    ...
    if (category1.includes(classValue)) {
        return 'Category 1';
    }

    if (category2.includes(classValue)) {
        return 'Category 2';
    }

    if (category3.includes(classValue)) {
        return 'Category 3';
    }
...
const classCategory = getClassCategory(classes.value);
...
let classCategoryInput = document.getElementById("class_category_" + id);
if (!classCategoryInput) {
    classCategoryInput = document.createElement("input");
    classCategoryInput.type = "hidden";
    classCategoryInput.name = "class_category";
    classCategoryInput.id = "class_category_" + id;
    const form = document.getElementById("frm_admission_open_" + id);
    if (form) form.appendChild(classCategoryInput);
}
classCategoryInput.value = classCategory;
