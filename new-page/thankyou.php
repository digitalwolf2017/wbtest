...
<?php } ?>
    ...
    <main
        class="max-w-7xl w-full bg-white rounded-3xl shadow-xl shadow-slate-200/60 overflow-hidden flex flex-col md:flex-row min-h-[600px] relative z-10">

        <!-- LEFT IMAGE SECTION -->

        <section class="w-full md:w-1/2 p-12 flex items-center justify-center bg-slate-50/50 relative overflow-hidden">

            <div class="max-w-md w-full float-animation">

                <img src="assets/circle_image.png" alt="Kids education" class="w-full h-auto drop-shadow-2xl">

            </div>

            <div
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-orange-200 rounded-full blur-3xl opacity-30 -z-10">
            </div>
        ...
        <section
            class="w-full md:w-1/2 p-8 md:p-16 lg:p-20 flex flex-col justify-center text-center md:text-left bg-white relative z-10">
