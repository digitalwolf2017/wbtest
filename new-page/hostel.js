...
function getBranch(val, id) {
  if (val == 'BARDHAMAN') {
    $('#branch_' + id).html('<option value="">Select Branch</option><option value="Andal">Andal</option>');
    ...
    $('#branch_' + id).html('<option value="">Select Branch</option><option value="Siliguri">Siliguri</option><option value="Fulbari">Fulbari</option>');
  }   else if (val == 'Kolkata') {
    $('#branch_' + id).html('<option value="">Select Branch</option><option value="Joka">Joka</option>');
  } 
